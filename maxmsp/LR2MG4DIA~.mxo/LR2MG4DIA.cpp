...
// author: "SMERM"
//
// Code generated with Faust 0.10.5 (http://faust.grame.fr)
//----------------------------------------------------------
...
class mydsp : public dsp {
  ...
  public:
	virtual void metadata(Meta* m) { 
		m->declare("name", "LR2MG4DIA");
		m->declare("version", "0.1");
		m->declare("author", "SMERM");
		m->declare("description", "Gerzon's matrix to reproduce LR into 4 ch diamond configuration");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("LR2MG4DIA");
		ui_interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			output0[i] = (FAUSTFLOAT)(0.5 * (fTemp0 + fTemp1));
			output1[i] = (FAUSTFLOAT)fTemp0;
			output2[i] = (FAUSTFLOAT)fTemp1;
			output3[i] = (FAUSTFLOAT)(0.5 * (fTemp0 - fTemp1));
		}
	}
};
